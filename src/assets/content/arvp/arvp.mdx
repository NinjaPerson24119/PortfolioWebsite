...
![[histogram-technique-gate-detector.jpg]]
...
![[ARVP_MemberOfMonth_November.png]]
...
![[gslicr-with-grid.png]]

![[superpixels-nice-output.png]]
...
![[shape-matcher-database-generator.png]]
...
![[path-detector-with-superpixels.png]]
...
[You can find the complete document here](https://github.com/NinjaPerson24119/Onboarding2019/blob/master/(opensource)%202019%20Software%20Onboarding.pdf)

![[2019-onboarding-cover.png]]
### Task Management
...
![[gazebo-underwater.png]]
![[gazebo-over-gate.png]]
![[arctos-motion-gazebo.ogv]]
## Project Co-Lead
...
![[openchisel-3d-reconstruction.png]]
...
![[arvp-computer-vision-presentation.png]]

The culmination of this was a presentation that I delivered in person at UAlberta.
